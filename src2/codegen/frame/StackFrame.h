...
public:
    ...
    void setSavesReturnAddress(bool enabled);
    void setUsesFramePointer(bool enabled);
    ...
    [[nodiscard]] bool savesReturnAddress() const;
    [[nodiscard]] bool usesFramePointer() const;
...
private:
    ...
    bool savesReturnAddress_ = true;
    bool usesFramePointer_ = true;
